...
<body>
	...
	<div id="body" style="overflow-y: auto;">
		<br><br>
		<center>
			<form action="transaction.php?item=send" method="POST">
				<table cellpadding="15">
					<tr>
						<td><b><span class="acctable">Recipient identifier<b style="color: red;">*</b></span></b></td>
						<td><b><span class="acctable">:</span></b></td>
						<td><b><span class="acctable"><input class="input" type="text" name="identifier" title="Give Recipient E-Mail or phone" required></span></b></td>
					</tr>
					...
					<tr>
						<td> </td>
						<td colspan="2"><b><span class="acctable"><input type="radio" name="selacc" value="priacc" checked> Primary Account</span></b></td>
					</tr>

					<tr>
						<td> </td>
						<td colspan="2"><b><span class="acctable"><input type="radio" name="selacc" value="tijnwal" > TIJN Wallet</span></b></td>
					</tr>
					...
					<?php
						if (mysqli_num_rows($run) > 0)
						{
				    		...
				    		{
				       		 	echo "<tr><td> </td>";
				       		 	echo '<td colspan="2"><b><span class="acctable"><input type="radio" name="selacc" value="'.$data["bankid"].','.$data["banumber"].'" > Bankid:'.$data["bankid"].'<br>&nbsp &nbsp &nbspAccount No:'.$data["banumber"].'</span></b></td>';
				       		 	echo "</tr>";
				    		}
						} 	
					?>
					...
					<tr>
						<td colspan="3"><center><b><span class="acctable"><input type="submit" name="submit" value="Send Money" class="inp">  <input type="reset" name="reset" value="Reset" class="inp"></span></b></center></td>
					</tr>
				</table>
			</form>
		</center>
